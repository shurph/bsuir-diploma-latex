...
\input{FontsWindows}% не забудьте закомментировать \input{fonts_linux}

% Рекомендовано для Linux (нужен scalable-cyrfonts-tex, подробности см. в fonts_linux.tex)
% раскомментировать, чтобы использовать:
%\input{FontsLinux}% не забудьте закомментировать \input{fonts_windows}
...
\setlist[enumerate, 2]{itemindent=\parindent + \parindent - 3.7ex, leftmargin=\parindent}
\setlist[enumerate, 3]{itemindent=\parindent + \parindent - 3.7ex, leftmargin=\parindent - .7ex}
