...
\usepackage[left=3cm,top=1.5cm,right=2cm,bottom=2cm]{geometry}
% Внимание! Принтеры склонны добавлять собственные отступы, 
% из-за чего может понадобится следующая коррекция:
% \usepackage[left=2.5cm,top=1.3cm,right=1.3cm,bottom=2cm]{geometry}
...
\renewcommand\subsection{%
  \@startsection{subsection}{2}%
    ...
    {\raggedright\hyphenpenalty=10000\normalfont\normalsize\bfseries}}
\makeatother
% Далее приведен вариант для кафедры ПОИТ: номер - полужирным, текст заголовка - обычным.
% \makeatletter
% \renewcommand\subsection{%
%   \@startsection{subsection}{2}%
...
\captionsetup[subfigure]{labelformat=stbsubfigure,labelsep=stb}
...
% Зачем: чтобы был доступен счетчик страниц pagesLTS.pagenr. 
\usepackage{pageslts}
