...
% Почему: Пункт 2.2.7 Требований по оформлению пояснительной записки.
\makeatletter
\renewcommand{\l@chapter}{\@dottedtocline{1}{0em}{1.2em}}
\renewcommand{\l@section}{\@dottedtocline{2}{0.5em}{2.0em}}
\renewcommand{\l@subsection}{\@dottedtocline{3}{1.7em}{2.8em}}
\makeatother
...
% фикс для диссертации - теперь нужно по центру ...
\fancyhf{} % очистка текущих значений
\fancyfoot[R]{\centering\thepage} % установка верхнего колонтитула
...
{ГЛАВА \thechapter} % label
{0pt} % sep
{
} % before-code
[
] % after-code
\titlespacing*{\chapter}{\fivecharsapprox}{-4ex}{3ex}

\titleformat{\section}
{\normalfont\large\bfseries}{\thesection}{1em}{}
\titlespacing*{\section}{\fivecharsapprox}{3.5ex plus 1ex minus .2ex}{2.3ex plus .2ex}

\titleformat{\subsection}{\normalfont\large\bfseries}{\thesubsection}{1em}{}
\titlespacing*{\subsection}{\fivecharsapprox}{3.25ex plus 1ex minus .2ex}{1.5ex plus .2ex}
